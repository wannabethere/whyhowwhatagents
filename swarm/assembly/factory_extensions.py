from .factory import SwarmPipeFactory
from swarm.pipes.retrieval.multi_search import MultiSearchPipe
from swarm.pipes.retrieval.query_transform_pipe import QueryTransformPipe


class R2RPipeFactoryWithMultiSearch(SwarmPipeFactory):
