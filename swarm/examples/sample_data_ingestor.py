...
class SampleDataIngestor:
    ...
    def __init__(
        ...
        self.config = SwarmConfig.from_json(config_path="/Users/sameerm/llm/agent_swarm_framework/swarm/examples/configs/local_ollama_rerank.json")
    ...
    def ingest_sample_file(self, no_media: bool = True, option: int = 0):
        ...
        response = self.executor.aingest_documents(
