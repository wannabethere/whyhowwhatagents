...
from swarm.models.document import  Extraction, DocumentType, Document, ExtractionType
from swarm.logging.kv_logger import KVLoggingSingleton
from swarm.models.exception import SwarmDocumentProcessingError

from swarm.parsers.media.audio_parser import AudioParser
from swarm.parsers.media.docx_parser import DOCXParser
from swarm.parsers.media.img_parser import ImageParser
from swarm.parsers.media.movie_parser import MovieParser
from swarm.parsers.media.pdf_parser import PDFParser
from swarm.parsers.media.ppt_parser import PPTParser
from swarm.parsers.structured.csv_parser import CSVParser
from swarm.parsers.structured.json_parser import JSONParser
from swarm.parsers.structured.xlsx_parser import XLSXParser
from swarm.parsers.text.html_parser import HTMLParser
from swarm.parsers.text.md_parser import MDParser
from swarm.parsers.text.text_parser import TextParser
...
class ParsingPipe(AsyncPipe):
    ...
    async def _parse(
        ...
        run_id: uuid.UUID,
        version: str,
    ) -> AsyncGenerator[Union[SwarmDocumentProcessingError, Extraction], None]:
        if document.type not in self.parsers:
            yield SwarmDocumentProcessingError(
