...
def register_tool_from_file(tool_function, tool_filename, agent_name, tool_path="./AgentTools"):
...
if (__name__ == "__main__"):
    register_tool_from_file("image_downloader", "ImageDownloader.py", "agent1", tool_path="../AgentTools")
