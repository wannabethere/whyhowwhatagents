...
from swarm.base.base_utils import generate_id_from_label
from swarm.models.vector import Vector,VectorEntry, VectorType
from swarm.models.search import VectorSearchRequest,VectorSearchResult
...
def test_vector_entry_serialization():
    ...
    assert serializable["document"] == [1.0, 2.0]
    assert isinstance(
